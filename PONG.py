...
def Arena():
    ...
    pygame.draw.rect(DISPLAYSURF, Orange, ((0,0),(600,600)), LineThickness/4)
    pygame.draw.rect(DISPLAYSURF, Orange, ((600,0),(600,600)), LineThickness/4)
    pygame.draw.rect(DISPLAYSURF, Blue, ((0,0),(1200,600)), LineThickness*2)
