...
from basicpages import Page, SplashScreen, TextInput, LeaderBoard
...
class Browser(object):
    ...
    def run(self):
        ...
        def cb2(value):
            self.name_2 = value
            self.get_shower(BoardPage, (self.name_1, self.name_2))()
        
        self.event_manager.add_timer(0.5, self.get_shower(TextInput, "Enter Player 1's name", cb1))
